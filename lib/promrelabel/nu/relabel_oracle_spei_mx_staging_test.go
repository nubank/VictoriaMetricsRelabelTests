...
func TestRelabelOracleSpeiMxStaging(t *testing.T) {
  ...
  `{__address__="10.115.10.100:9161",__metrics_path__="/metrics",__scheme__="http",__scrape_interval__="30s",__scrape_timeout__="20s",job="oracle-spei-mx-staging"}`,

  true,

  `{job="oracle-spei-mx-staging",db_instance="primary"}`)
}