...
func TestRelabelJmxSparkMaster(t *testing.T) {
  ...
  `{__address__="10.40.32.51:10001",__meta_ec2_ami="ami-0800ccecb35a809d2",__meta_ec2_architecture="x86_64",__meta_ec2_availability_zone="us-east-1c",__meta_ec2_availability_zone_id="use1-az6",__meta_ec2_instance_id="i-005049aa0352509a7",__meta_ec2_instance_state="running",__meta_ec2_instance_type="r5d.2xlarge",__meta_ec2_owner_id="877163210394",__meta_ec2_primary_subnet_id="subnet-06fd4566c6a541685",__meta_ec2_private_dns_name="ip-10-40-32-51.ec2.internal",__meta_ec2_private_ip="10.40.32.51",__meta_ec2_region="us-east-1",__meta_ec2_subnet_id=",subnet-06fd4566c6a541685,",__meta_ec2_tag_NU_APP="jetty",__meta_ec2_tag_NU_ENV="prod",__meta_ec2_tag_NU_LAYER="mesos-fixed",__meta_ec2_tag_NU_NAME="prod-foz-liquorice-mesos-fixed",__meta_ec2_tag_NU_OPERATING_COST_CENTER="110005",__meta_ec2_tag_NU_PROTOTYPE="foz",__meta_ec2_tag_NU_ROLE="app",__meta_ec2_tag_NU_SERVICE="mesos-fixed",__meta_ec2_tag_NU_SQUAD="data-infra",__meta_ec2_tag_NU_STACK="prod-liquorice",__meta_ec2_tag_Name="prod-foz-liquorice-mesos-fixed",__meta_ec2_tag_REMEDIATED_AT="2024-05-14T08:13:46.547",__meta_ec2_tag_aws_autoscaling_groupName="prod-foz-liquorice-mesos-fixed-BlueGroup-LA5I4NSGLHE1",__meta_ec2_tag_aws_cloudformation_logical_id="BlueGroup",__meta_ec2_tag_aws_cloudformation_stack_id="arn:aws:cloudformation:us-east-1:877163210394:stack/prod-foz-liquorice-mesos-fixed/12508560-76f7-11ed-9af6-0e93645bbbab",__meta_ec2_tag_aws_cloudformation_stack_name="prod-foz-liquorice-mesos-fixed",__meta_ec2_vpc_id="vpc-00f2a5d5f6afcb6dc",__metrics_path__="/metrics",__scheme__="http",__scrape_interval__="2m",__scrape_timeout__="30s",job="jmx-spark-master"}`,

  true,

  `{job="jmx-spark-master",environment="prod",instance="10.40.32.51",instance_type="r5d.2xlarge",prototype="foz",service="mesos-fixed",squad="data-infra"}`)
}